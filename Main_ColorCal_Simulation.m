...
SensorSpectralResponseFilename="C:\Monirul\Matlab world\WFOV_24MP_ColorCalibration\ColorSimulation_data\Sensor Spectral Response.xlsx";
...
if(bAnalyzeNonShiftedSpectrum)
    ...
    filename = 'C:\Monirul\Matlab world\WFOV_24MP_ColorCalibration\ColorSimulation_data\Simulated Calibration Data.xlsx';
    col_header={'Red Color','Green Color','Blue Color','X','Y','Z','R Counts ','G Counts','B Counts'};     %Row cell array (for column labels)
    xlswrite(filename,XYZ_RGB,'Sheet1','A2');     %Write data
...
if(bAnalyzeShiftedSpectrum)
    ...
    CalMatrixFilename="C:\Monirul\Matlab world\WFOV_24MP_ColorCalibration\ColorSimulation_data\Calibration Matrix.xlsx";
    ...
    filename = 'C:\Monirul\Matlab world\WFOV_24MP_ColorCalibration\ColorSimulation_data\Error For Spectrum Shift.xlsx';
    ...
    xlswrite(filename,Result,'Sheet1','A2');         %Write data
    xlswrite(filename,col_header,'Sheet1','A1');     %Write column header
